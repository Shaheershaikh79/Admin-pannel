...
export function TimetableFilter({ listLoading }) {
  ...
  const applyFilter = (values) => {
    const newQueryParams = prepareFilter(timetableUIProps.queryParams, values);
    if (!isEqual(newQueryParams, timetableUIProps.queryParams)) {
      newQueryParams.pageNumber = 1;
      // update list by queryParams
      timetableUIProps.setQueryParams(newQueryParams);
    }
  };
